...
function Slike({ socket, gameState }) {
    ...
    const handleWrongDeckGuess = (element) => {
    ...
    return (
        <div className="container">
            <div className="opponent">
                ...
                <Card card={gameState.players[opponentPlayerIndex].card} handleGuess={handleWrongDeckGuess} />
            ...
            <div className="main-player">
                ...
                <Card card={gameState.players[mainPlayerIndex].card} handleGuess={handleWrongDeckGuess} />
